...
const NavBar = () => {
  return (
    <nav className="bg-stone-800 h-20 justify-between flex flex-row items-center px-5 md:px-10">
      ...
      <div className="font-domine">
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuTrigger className="text-white group inline-flex h-9 w-max items-center justify-center rounded-md bg-stone-800 px-2 py-1 md:px-4 md:py-2 text-sm font-medium transition-colors hover:bg-stone-800 hover:text-white focus:bg-stone-800 focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-stone-800 data-[state=open]:bg-stone-800">
                Sobre
              </NavigationMenuTrigger>
              <NavigationMenuContent>
            ...
            <NavigationMenuItem>
              <Link
                ...
                legacyBehavior
              >
                <NavigationMenuLink className="text-white text-sm font-medium px-2 py-1 md:px-4 md:py-2">
                  GitHub
                </NavigationMenuLink>
              </Link>
            </NavigationMenuItem>
